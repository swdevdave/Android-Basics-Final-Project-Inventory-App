        ...
        mProductSupplierNameSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    ...
                    } else if (selection.equals(getString(R.string.supplier_powell))) {
                        mSupplierName = InventoryEntry.SUPPLIER_POWELL;
                    } else if (selection.equals(getString(R.string.supplier_barnesandnoble))) {
                        mSupplierName = InventoryEntry.SUPPLIER_BARNESANDNOBLE;
                    } else {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                case InventoryEntry.SUPPLIER_AMAZON:
                    ...
                    break;
                case InventoryEntry.SUPPLIER_POWELL:
