...
class InventoryCursorAdapter extends CursorAdapter {
    ...
    public void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        // Sets Click listener to sale button to decrease inventory count.
        ...
        // Sets the Price of the product (Ex. Price : $ 15)
        productPriceTextView.setText(new StringBuilder().append(context.getString(R.string.product_price)).append(" : ").append(context.getString(R.string.product_price_currency)).append(" ").append(productPrice).toString());
        // Sets the quantity
        productQuantityTextView.setText(new StringBuilder().append(context.getString(R.string.product_quantity)).append(" : ").append(productQuantity).toString());
        // Button to open edit product view
